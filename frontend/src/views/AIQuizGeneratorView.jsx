...
export const AIQuizGeneratorView = () => {
  const { setCurrentScreen, setActiveQuizType, showToast } = useApp();
  ...
  const generationStages = [
    "Analysing official learning material & extracting text chunks...",
    "Retrieving key statistical concepts & sample methodologies...",
    "Synthesizing source-grounded questions with Bloom's Taxonomy...",
    "Validating answer keys against document citations & DPDP guidelines..."
  ];
