...
export const seedUsers = [
  // 1. Employee default
  {
    ...
    competencies: [
      { id: "post-1", name: "Post Office Operations & Mail Logistics", currentLevel: 3, targetLevel: 4, importance: 4, roleRelevance: 1.0 },
      { id: "post-2", name: "Post Office Savings Bank (POSB) & IPPB Micro-Banking", currentLevel: 2, targetLevel: 4, importance: 5, roleRelevance: 1.0 },
      { id: "post-3", name: "Dak Ghar Niryat Kendra (DNK) & Commercial Parcel Logistics", currentLevel: 1, targetLevel: 3, importance: 4, roleRelevance: 0.9 },
      { id: "post-4", name: "Post Office Act 2023 Statutory Compliance & Security", currentLevel: 2, targetLevel: 3, importance: 4, roleRelevance: 0.9 },
      { id: "post-5", name: "Customer Relationship Management & CPGRAMS in India Post", currentLevel: 3, targetLevel: 4, importance: 4, roleRelevance: 0.85 },
      { id: "gov-1", name: "Code of Ethics, Counter Cash Integrity & Prevention of Vigilance Lapses", currentLevel: 4, targetLevel: 4, importance: 3, roleRelevance: 0.8 }
    ],
